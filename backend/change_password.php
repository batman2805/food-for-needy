                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <input type="text" class="form-control" id="val-state name" name="New_Password" placeholder="Enter a new password..">
                                                    </div>
                                                </div>
                                                <div class="row">      
                                            <div class="col-xl-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <input type="text" class="form-control" id="val-state name" name="Confirm_Password" placeholder="Enter a confirm password..">
                                                    </div>
                                                </div>
