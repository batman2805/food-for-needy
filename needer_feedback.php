...
<textarea class="form-control valid" name="needer_feedback_message" placeholder="Enter your message" required="true"></textarea>
...
<?php
                                                    if(isset($_POST['submit']))
                                                    {
                                                      $date=date('d-m-y');
                                                      session_start();
                                                      $qry="insert into needer_feedbacks values('','".$_POST['needer_id']."','".$_POST['needer_feedback_message']."','$date')";
